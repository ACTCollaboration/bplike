...
#----------------------------------------------------
#SBATCH -J appbpl      # Job name
#SBATCH -o appbpl.o%j	  # Name of stdout output file
#SBATCH -e appbpl.e%j	  # Name of stderr error file
...
mpirun -np 4 /home1/08134/tg874332/.local/bin/cobaya-run /home1/08134/tg874332/bplike/run_scripts/act_extended_act_plus_planck_bp_mcmc_classy_stampede_large.yml -f
