...
class act_pylike_extended(_InstallableLikelihood):
    ...
    def initialize(self):
        ...
        self.fparams = utils.config_from_yaml('params_extended.yml')['fixed']
        self.aparams = utils.config_from_yaml('params_extended.yml')['act_like']
        self.bpmodes = utils.config_from_yaml('params_extended.yml')['bpass_modes']
    ...
    def prepare_data(self, verbose=False):
        ...
        self.sp = StevePower("data/actpolfull_dr4.01/data/data_act/",self.flux)
        if self.bandpass:
